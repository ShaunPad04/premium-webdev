              ...
              <div className="mt-7 flex flex-wrap items-center gap-x-7 gap-y-4">
                ...
                {contactInfo.secondary ? (
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-[14px] text-bb-grey-dark underline decoration-[rgba(14, 11, 12,0.25)] underline-offset-4 transition-colors hover:text-bb-black hover:decoration-current"
                  >
