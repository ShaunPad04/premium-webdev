...
export function CoverFlowCarousel() {
  ...
  return (
    ...
    >
      ...
      {/* No colour/size picker under the centre piece (2026-09-24, Brad):
          the card is a link to the piece's own page, which has them. It
          was one of four buy blocks on the home page. */}
    </section>
  );
}
